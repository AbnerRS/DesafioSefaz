...
public class Controller extends HttpServlet {
	...
	// fazer a verificação se o usuário está cadastrado no banco para realizar o
	// login
	...
	protected void novoUsuario(HttpServletRequest request, HttpServletResponse response)
		...
		// invocar o Inserir passando o usuário
	...
	// Listar Usuário separadamento na aba de editar
	protected void editarUsuario(HttpServletRequest request, HttpServletResponse response)
		...
		// Executar o método escolheUsuario
		usrDAO.escolheUsuario(usr);

		// Setar os atributos do formulário com o Conteúdo do Usuário da tabela
	...
	protected void updateUsuario(HttpServletRequest request, HttpServletResponse response)
		...
		// executando o método de alterar o usuario
		usrDAO.alterarUsuario(usr);

		// redirecionar para o documento principal.jsp ( atualizar as alterações)
		response.sendRedirect("main");
